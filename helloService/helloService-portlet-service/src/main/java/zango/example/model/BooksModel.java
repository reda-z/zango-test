...
/**
 * The base model interface for the Books service. Represents a row in the &quot;helloService_Books&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link zango.example.model.impl.BooksModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link zango.example.model.impl.BooksImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see Books
 * @see zango.example.model.impl.BooksImpl
 * @see zango.example.model.impl.BooksModelImpl
 * @generated
 */
public interface BooksModel extends BaseModel<Books> {
    ...
    @Override
    public CacheModel<zango.example.model.Books> toCacheModel();
